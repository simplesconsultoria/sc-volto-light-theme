...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-sc.voltolighttheme:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-sc.voltolighttheme:initial")
        transaction.commit()
    app._p_jar.sync()
